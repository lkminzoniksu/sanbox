...
class Room(Billable, ABC):
    ...
    def __init__(self, room_number:int, bed_type: BedType,
                 smoking: bool, room_type: RoomType) -> None:
        """Initialize a room with basic attributes."""

        self._room_number = room_number
        self._bed_type = bed_type
        self._room_type = room_type
        self._amenities: Set[Amenity] = set()
    ...
    def remove_amenity(self, amenity: Amenity) -> None:
        ...
        self._amenities.discard(amenity)

    # add / clear special requests
    @property
