...
class TestDeluxeRoom:
    ...
    def setup_method(self) -> None:
        """Create reusable deluxe room."""
        self.room = DeluxeRoom(
            201,
            BedType.KING,
            False,
        )
    ...
    def test_add_special_request(self) -> None:
        ...
        self.room.add_special_request("Extra pillows")

        assert "Extra pillows" in self.room.special_requests
