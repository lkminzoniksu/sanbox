...
class TestPenthouseRoom:
    ...
    def setup_method(self) -> None:
        """Create reusable penthouse room."""
        self.room = PenthouseRoom(
            401,
            BedType.KING,
            False,
        )
    ...
    def test_add_amenity(self) -> None:
        ...
        self.room.add_amenity(Amenity.JACUZZI)

        assert Amenity.JACUZZI in self.room.amenities
    ...
    def test_remove_amenity(self) -> None:
        ...
        self.room.add_amenity(Amenity.JACUZZI)
        self.room.remove_amenity(Amenity.JACUZZI)

        assert Amenity.JACUZZI not in self.room.amenities
    ...
    def test_add_special_request(self) -> None:
        ...
        self.room.add_special_request("Private dinner")

        assert "Private dinner" in self.room.special_requests
